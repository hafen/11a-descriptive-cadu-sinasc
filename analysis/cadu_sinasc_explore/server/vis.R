d2 <- data.table::fread("~/Desktop/Rally/CoorteKI_Rally/KI_Rally_Sprint11A/Shared_Rally/CINASC_CADU_mapped_11-08.csv", na.strings = "") %>% as_data_frame()
...
pth10 <- "results/cadu_sinasc/preterm_rf_geo_summ"
...
pth11 <- "results/cadu_sinasc/cesarean_rf_geo_summ"
